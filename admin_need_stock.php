...
<!TO PERFORM UNIT ADDING TO DATABASE>
      ...
      if (isset($_POST["myselectbox"])&&($_POST["unit"])){
                ...
                if($_POST['myselectbox']=='A-positive'){
                          ...
                          $row = mysqli_fetch_assoc($result);
                          $new_unit = $row['UNIT']+$_POST["unit"];
                          $sql = "UPDATE stock SET UNIT = $new_unit WHERE ID = 3";
                ...
                if($_POST['myselectbox']=='A-negative'){
                          ...
                          $row = mysqli_fetch_assoc($result);
                          $new_unit = $row['UNIT']+$_POST["unit"];
                          $sql = "UPDATE stock SET UNIT = $new_unit WHERE ID = 4";
                ...
                if($_POST['myselectbox']=='B-positive'){
                          ...
                          $row = mysqli_fetch_assoc($result);
                          $new_unit = $row['UNIT']+$_POST["unit"];
                          $sql = "UPDATE stock SET UNIT = $new_unit WHERE ID = 5";
                ...
                if($_POST['myselectbox']=='B-negative'){
                          ...
                          $row = mysqli_fetch_assoc($result);
                          $new_unit = $row['UNIT']+$_POST["unit"];
                          $sql = "UPDATE stock SET UNIT = $new_unit WHERE ID = 6";
                ...
                if($_POST['myselectbox']=='AB-positive'){
                          ...
                          $row = mysqli_fetch_assoc($result);
                          $new_unit = $row['UNIT']+$_POST["unit"];
                          $sql = "UPDATE stock SET UNIT = $new_unit WHERE ID = 7";
                ...
                if($_POST['myselectbox']=='AB-negative'){
                          ...
                          $row = mysqli_fetch_assoc($result);
                          $new_unit = $row['UNIT']+$_POST["unit"];
                          $sql = "UPDATE stock SET UNIT = $new_unit WHERE ID = 8";
