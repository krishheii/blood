                ...
                <div class="panel panel-primary">
					...
					<form autocomplete="off" method="post"  action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<option value="O+">AB-positive </option>
							<option value="AB+">A-negative</option>
							<option value="A1+">O-negative</option>
							<option value="A2+">B-positive</option>
							<option value="A1B+">O-positive</option>
